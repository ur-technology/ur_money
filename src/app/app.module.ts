...
@NgModule({
  ...
  providers: [AuthService, ChartDataService, ContactsService, CountryListService, EncryptionService, EventsService, ToastService, DynamicLinkService, { provide: ErrorHandler, useClass: IonicErrorHandler }]
})
